...
input,select,button{width:95%;padding:10px;margin:5px 0;border-radius:8px;border:1px solid #ccc}
button{background:#007bff;color:#fff;border:none}
.viewer{margin-top:10px;height:70vh;border-top:2px solid #ccc}
...
<input type="text" id="urlInput" placeholder="Digite o link do site (ex: example.com)">
...
<button onclick="carregarComDelay()">Carregar Site com Delay</button>
...
function carregarComDelay(){
 ...
 status.innerText = 'Carregando com delay...';
